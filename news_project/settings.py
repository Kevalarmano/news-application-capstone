...
- Login via django.contrib.auth
- Basic REST-style JSON endpoint for subscribed articles
"""
...
# Simple default DB (works in Codespaces + locally)
DATABASES = {
    "default": {
...
# Dev email backend (prints emails to terminal)
